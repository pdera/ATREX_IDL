...
pro WID_BASE_0A, GROUP_LEADER=wGroup, _EXTRA=_VWBExtra_
  ...
  WID_BUTTON_1 = Widget_Button(WID_BASE_0A, UNAME='WID_BUTTON_1'  $
      ,XOFFSET=100 ,YOFFSET=91 ,SCR_XSIZE=50 ,SCR_YSIZE=22  $
      ,/ALIGN_CENTER ,VALUE='OK')

  WID_BUTTON_2 = Widget_Button(WID_BASE_0A, UNAME='WID_BUTTON_2'  $
      ,XOFFSET=160 ,YOFFSET=91 ,SCR_XSIZE=50 ,SCR_YSIZE=22  $
