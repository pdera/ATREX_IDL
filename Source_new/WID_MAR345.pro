...
;******************************* NEW CODE **********************
  ...
  WID_MAR345 = Widget_Base( GROUP_LEADER=wGroup, UNAME='WID_MAR345'  $
      ...
      ,TITLE='ATREX ver 1.0, April 25, 2016' ,SPACE=3 ,XPAD=3 ,YPAD=3)
 ...
 ;     ,YSIZE=1)
  ...
  WID_BUTTON_OMEGA_ROTATION = Widget_Button(WID_BASE_OMEGA_ROTATION1, UNAME='WID_BUTTON_OMEGA_ROTATION'  $
      ,/ALIGN_LEFT ,VALUE='Invert phi rotation')
...
WID_BUTTON_20aa5 = Widget_Button(WID_BASE_10, UNAME='WID_BUTTON_20aa5'  $
  ...
  WID_LABEL_18a = Widget_Label(WID_BASE_2, UNAME='WID_LABEL_18a'  $
      ,XOFFSET=225 ,YOFFSET=10 ,/ALIGN_LEFT ,VALUE='Compression')
  ...
  WID_TEXT_0a = Widget_Text(WID_BASE_2, UNAME='WID_TEXT_0a'  $
      ,XOFFSET=310 ,YOFFSET=6 ,SCR_XSIZE=60 ,SCR_YSIZE=21 ,XSIZE=20  $
      ,YSIZE=1)
  ...
  WID_BUTTON_9b = Widget_Button(WID_BASE_0a, UNAME='WID_BUTTON_9b'  $
      ,/ALIGN_LEFT ,VALUE='Use compression',UVALUE='')
...
;      ,YSIZE=1, value=['omega','kappa','phi','energy'])
  ...
  WID_BUTTON_49_1 = Widget_Button(WID_BASE_4, UNAME='WID_BUTTON_49_1'  $
      ,XOFFSET=187 ,YOFFSET=320 ,SCR_XSIZE=100 ,SCR_YSIZE=20  $
      ,/ALIGN_CENTER ,VALUE='Open gonio')

  WID_BUTTON_49_2 = Widget_Button(WID_BASE_4, UNAME='WID_BUTTON_49_2'  $
      ,XOFFSET=187 ,YOFFSET=345 ,SCR_XSIZE=100 ,SCR_YSIZE=20  $
      ,/ALIGN_CENTER ,VALUE='Save gonio')

  WID_BUTTON_49_3 = Widget_Button(WID_BASE_4, UNAME='WID_BUTTON_49_3'  $
      ,XOFFSET=187 ,YOFFSET=370 ,SCR_XSIZE=100 ,SCR_YSIZE=20  $
      ,/ALIGN_CENTER ,VALUE='Clear gonio')
...
;-------------------------------------------------
 ...
 WID_BASE_1z = Widget_Base(WID_BASE_4, UNAME='WID_BASE_1' ,XOFFSET=28  $
  ...
  WID_LABEL_1z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_1z'  $
      ,XOFFSET=25 ,YOFFSET=50 ,/ALIGN_LEFT ,VALUE='Eta')


  WID_LABEL_2z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_2z'  $
      ,XOFFSET=25 ,YOFFSET=75 ,/ALIGN_LEFT ,VALUE='Chi')


  WID_LABEL_3z = Widget_Label(WID_BASE_1z, UNAME='WID_LABEL_3z'  $
      ,XOFFSET=25 ,YOFFSET=100 ,/ALIGN_LEFT ,VALUE='Phi')
...
WID_BUTTON_refine_calt_p = Widget_Button(WID_base_ref_cal_type, UNAME='WID_BUTTON_refine_cal_p'  $
      ,/ALIGN_Left ,VALUE='Fit2d (X-Z-X)')

WID_BUTTON_refine_calt_s = Widget_Button(WID_base_ref_cal_type, UNAME='WID_BUTTON_refine_cal_s'  $
      ,/ALIGN_Left ,VALUE='Y-Z')

WIDGET_CONTROL, WID_BUTTON_refine_calt_p, SET_BUTTON=1
...
;      ,XSIZE=6 ,YSIZE=1)
  ...
  WID_DRAW_0 = Widget_Draw(WID_MAR345, UNAME='WID_DRAW_0' ,XOFFSET=4  $
      ,YOFFSET=63 ,SCR_XSIZE=600 ,SCR_YSIZE=600, /motion_events)
